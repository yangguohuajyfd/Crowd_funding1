				...
				<ul style="padding-left:0px;" class="list-group">
					...
					<li class="list-group-item">
						...
						<ul style="margin-top:10px;">
							...
							<li style="height:30px;">
								<a href="${APP_PATH }/role/index" style="color:red;"><i class="glyphicon glyphicon-certificate"></i> 角色维护</a> 
							</li>
							<li style="height:30px;">
			  ...
			  <div class="panel-body">
				<form role="form" id="roleForm">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="rolename" value="${role.rolename }" placeholder="角色名称">
				  </div>
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	$.ajax({
			    		...
			    		success : function(result){
			    			  ...
			    			  if(result.success){
			    				  layer.msg("角色信息修改成功", {time:2000, icon:6}, function(){
